...
export const HashLinkPage: React.FC = () => {
  return (
    <div>
      <section style={{ backgroundColor: '#F0F0F0' }} id="section-one">
        ...
        <ul>
          <li>
            <HashLink to="/test/">Home</HashLink>
          </li>
          <li>
            <HashLink smooth to={'/test/#section-two'}>
              Section Two
            </HashLink>
          </li>
          <li>
            <HashLink
              ...
              to={'/test/#section-three'}
            >
              Section Three
            </HashLink>
          </li>
          <li>
            <HashLink smooth to={'/test/#focusable-heading'}>
              Focusable Heading
            </HashLink>
          </li>
          <li>
            <HashLink smooth to={'/test/#focusable-input'}>
              Text Input
            </HashLink>
          </li>
        </ul>
      ...
      <section style={{ backgroundColor: '#E0E0E0' }} id="section-two">
        ...
        <ul>
          ...
          <li>
            <HashLink smooth to={'/test/#section-one'}>
              Section One
            </HashLink>
          </li>
          <li>
          ...
          <li>
            <HashLink smooth to={'/test/#section-three'}>
              Section Three
            </HashLink>
          </li>
          <li>
            <HashLink smooth to={'/test/#top'}>
              Top of Page
            </HashLink>
          </li>
        </ul>
